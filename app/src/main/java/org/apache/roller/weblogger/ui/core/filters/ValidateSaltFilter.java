...
public class ValidateSaltFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if ("POST".equals(httpReq.getMethod()) && !isIgnoredURL(requestURL)) {
            RollerSession rollerSession = getRollerSession(httpReq);
            if (rollerSession != null) {
                ...
                SaltCache saltCache = getSaltCache();
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        String urls = getIgnoredUrlsProperty();
    ...
    /**
     * Retrieve the ignored URLs property. Protected for testing.
     */
    protected String getIgnoredUrlsProperty() {
        return WebloggerConfig.getProperty("salt.ignored.urls");
    }

    /**
     * Retrieve the SaltCache instance. Protected for testing.
     */
    protected SaltCache getSaltCache() {
        return SaltCache.getInstance();
    }

    /**
     * Retrieve the RollerSession instance. Protected for testing.
     */
    protected RollerSession getRollerSession(HttpServletRequest request) {
