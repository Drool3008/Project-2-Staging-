...
/**
 * Command pattern implementation: Unstars a weblog for a user.
 */
public class UnstarWeblogCommand implements StarCommand {

    private final User user;
    private final Weblog weblog;
    private final StarFacade starFacade;

    public UnstarWeblogCommand(User user, Weblog weblog, StarFacade starFacade) {
        this.user = user;
        this.weblog = weblog;
    ...
    public String getDescription() {
        return "Unstar weblog '" + weblog.getHandle() + "' by user '" + user.getUserName() + "'";
    }
}
