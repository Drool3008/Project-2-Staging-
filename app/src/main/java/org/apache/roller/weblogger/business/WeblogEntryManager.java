...
public interface WeblogEntryManager {
    ...
    /**
     * Star a WeblogEntry for a user (add to favourites).
     */
    void starEntry(User user, WeblogEntry entry) throws WebloggerException;

    /**
     * Unstar a WeblogEntry for a user (remove from favourites).
     */
    void unstarEntry(User user, WeblogEntry entry) throws WebloggerException;
