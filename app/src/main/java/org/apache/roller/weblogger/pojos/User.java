...
public class User implements Serializable {
    ...
    @ManyToMany
    @JoinTable(name = "user_starred_weblog",
        joinColumns        = @JoinColumn(name = "user_id"),
        inverseJoinColumns = @JoinColumn(name = "weblog_id"))
    private Set<Weblog> starredWeblogs = new HashSet<>();

    @ManyToMany
    @JoinTable(name = "user_starred_entry",
        joinColumns        = @JoinColumn(name = "user_id"),
        inverseJoinColumns = @JoinColumn(name = "entry_id"))
    private Set<WeblogEntry> starredEntries = new HashSet<>();
    ...
    public Set<Weblog> getStarredWeblogs() {
        return starredWeblogs;
    }

    public void setStarredWeblogs(Set<Weblog> starredWeblogs) {
        this.starredWeblogs = starredWeblogs;
    }

    public Set<WeblogEntry> getStarredEntries() {
        return starredEntries;
    }

    public void setStarredEntries(Set<WeblogEntry> starredEntries) {
