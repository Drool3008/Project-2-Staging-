...
public class AddEntryOperation extends WriteToIndexOperation {
    ...
    private static Log logger = LogFactory.getFactory().getInstance(AddEntryOperation.class);

    // ~ Instance fields ========================================================

    private Indexable data;
     ...
     */
    public AddEntryOperation(Weblogger roller, LuceneIndexManager mgr, Indexable data) {
        super(mgr);
        this.roller = roller;
        this.data = data;
    }
