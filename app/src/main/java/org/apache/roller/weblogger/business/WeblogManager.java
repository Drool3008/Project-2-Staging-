...
public interface WeblogManager {
         ...
         * @param handle Handle of website
         */
        Weblog getWeblogByHandle(String handle, Boolean enabled) throws WebloggerException;
         ...
         */
        List<StarredWeblogEntry> getStarredWeblogsSortedByRecency(User user) throws WebloggerException;

        /**
         * Returns true if the given weblog is starred by the given user.
         */
