...
/**
 * Command pattern implementation: Stars a weblog entry for a user.
 */
public class StarEntryCommand implements StarCommand {

    private final User user;
    private final WeblogEntry entry;
    private final StarFacade starFacade;

    public StarEntryCommand(User user, WeblogEntry entry, StarFacade starFacade) {
        this.user = user;
        this.entry = entry;
    ...
    public String getDescription() {
        return "Star entry '" + entry.getTitle() + "' by user '" + user.getUserName() + "'";
    }
}
