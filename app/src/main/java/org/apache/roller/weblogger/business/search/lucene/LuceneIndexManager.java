...
import org.apache.roller.weblogger.pojos.Indexable;
import org.apache.roller.weblogger.pojos.FieldConstants;
...
public class LuceneIndexManager implements IndexManager {
    ...
    @Override
    public void addEntryIndexOperation(Indexable entry) throws WebloggerException {
        scheduleIndexOperation(new AddEntryOperation(roller, this, entry));
    }

    @Override
    public void addEntryReIndexOperation(Indexable entry) throws WebloggerException {
        scheduleIndexOperation(new ReIndexEntryOperation(roller, this, entry));
    }

    @Override
    public void removeEntryIndexOperation(Indexable entry) throws WebloggerException {
