 ...
 * one-direction associations with weblog entries, weblog categories, folders
 * and
 * other objects. Use UserManager to create, fetch, update and retrieve
 * websites.
 *
...
public class Weblog implements Serializable, IWeblogContext {
    ...
    @ManyToMany(mappedBy = "starredWeblogs")
    ...
    /**
     * Is autostreaming enabled for this weblog?
     */
    public boolean isAutostreamingEnabled() {
     ...
     * 
     * @param folderName Name or path of bookmark folder to be returned (null for
     *                   root)
